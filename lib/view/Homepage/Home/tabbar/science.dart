...
class Science extends ConsumerStatefulWidget {
  const Science({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _ScienceState();
}

class _ScienceState extends ConsumerState<Science> {
  List<LatestNews> latestnewsdetails = [
    ...
    LatestNews(
        ...
        title: 'Life',
        subtitle:
            "'We keep rising to new chScienceenges:\n' For churches hit by",
        source: 'USA Today',
        time: '4h ago',
        sourceimage: 'assets/Ellipse.png'),
  ];
