...
class Sports extends ConsumerStatefulWidget {
  const Sports({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _SportsState();
}

class _SportsState extends ConsumerState<Sports> {
  List<LatestNews> latestnewsdetails = [
    ...
    LatestNews(
        ...
        title: 'Life',
        subtitle:
            "'We keep rising to new chSportsenges:\n' For churches hit by",
        source: 'USA Today',
        time: '4h ago',
        sourceimage: 'assets/Ellipse.png'),
  ];
