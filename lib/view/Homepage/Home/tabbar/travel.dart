...
class Travel extends ConsumerStatefulWidget {
  const Travel({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _TravelState();
}

class _TravelState extends ConsumerState<Travel> {
  List<LatestNews> latestnewsdetails = [
    ...
    LatestNews(
        ...
        title: 'Life',
        subtitle:
            "'We keep rising to new chTravelenges:\n' For churches hit by",
        source: 'USA Today',
        time: '4h ago',
        sourceimage: 'assets/Ellipse.png'),
  ];
