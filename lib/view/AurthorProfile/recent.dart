...
class RecentTabs extends ConsumerStatefulWidget {
  const RecentTabs({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _RecentTabsState();
}

class _RecentTabsState extends ConsumerState<RecentTabs> {
  List<LatestNews> latestnewsdetails = [
    ...
    LatestNews(
        ...
        title: 'Life',
        subtitle: "'We keep rising to new \n' For churches hit by",
        source: 'USA Today',
        time: '4h ago',
        sourceimage: 'assets/Ellipse.png'),
  ];
